...
policy_net = Network((146, 7, 7), 7*7*7+1, 32)
target_net = Network((146, 7, 7), 7*7*7+1, 32)

checkpoint = torch.load("single_net.pth.tar")
...
winners, records = play_game(100, initialize_game)
print(winners)
