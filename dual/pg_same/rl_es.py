...
import sys
import numpy as np
from es import train_es_selfplay
sys.path.append("../..")
...
if __name__ == '__main__':
    initial_model = None
    checkpoint_file ="pg_es.pth.tar"
    reward_file = "pg_es_reward.pdf"
    ...
    for step in range(50000):
        ...
        if step % 101 == 0:
            ...
            train_es_selfplay(checkpoint_file, checkpoint_file, None, None, round=1)
            plt.clf()
