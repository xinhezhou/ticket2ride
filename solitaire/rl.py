...
from RLplayers.dqn_player import DQNPlayer, QValueNetwork, compute_input_matrix
...
if __name__ == '__main__':
    ...
    selfplay_checkpoint ="dqn_3.pth.tar"
    record_file = "dqn_record_3.json"
    memory_file = "dqn_memory_3.json"
    loss_file = "dqn_loss_3.pdf"
    policy_net = load_net(initial_checkpoint, 442, QValueNetwork)
    target_net = load_net(initial_checkpoint, 442, QValueNetwork, eval=True)
    ...
    for i in range(10000):
        ...
        if i % 1000 == 0:
            rewards, records = play_game(100, Game, DQNPlayer, model=policy_net, eps=0)
